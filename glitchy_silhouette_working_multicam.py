...
class GlitchySilhouetteProcessor:
    ...
    def __init__(self):
        ...
        # Soft thresholding parameters (using working version settings)
        ...
        # Performance monitoring (using old FPS calculation for stability)
        self.fps_counter = 0
    ...
    def process_frame(self, frame, camera_src=0):
        ...
        # Performance tracking (using old method)
        self.fps_counter += 1
    ...
    def add_debug_overlay(self, frame, contour_count, silhouette_pixels, camera_src=0):
        ...
        cv2.putText(frame, "[0-9] Switch Camera", (20, control_y), font, 0.5, (200, 200, 200), 1)
...
def main():
    print("🚀 Starting Glitchy Silhouette Replacement (Working + Multicam)")
